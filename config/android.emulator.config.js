...
exports.config = {
  ...
  //     "allure",
  //     {
  //       outputDir: "./test-execution_report/mobile-ui/allure-results",
  ...
  reporters: [
    ...
    [
      "html-nice",
      {
        outputDir: "./test-execution_report/mobile-ui/html-reports",
  ...
  //     "generate",
  //     "./test-execution_report/mobile-ui/allure-results",
  //     "--clean",
  //     "-o",
  //     "./test-execution_report/mobile-ui/allure-report",
  //   ]);
