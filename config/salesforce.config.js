...
exports.config = {
  ...
  // suites: {
  //   happy_flow_1: [
  //     "./test/specs/sfdc/end_2_end_flow/maker_checker_accept_all_checkpoints.js",
  //   ],
  //   happy_flow_2: [
  //     "./test/specs/sfdc/end_2_end_flow/maker_checker_accept_some_checkpoints.js",
  //   ],
  //   happy_flow_3: [
  //     "./test/specs/sfdc/end_2_end_flow/maker_checker_reject_all_checkpoints.js",
  //   ],
  // },
