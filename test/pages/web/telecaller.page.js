class telecaller{
    constructor(){
        ...
        this.emailLabel = '//*[@for="emailId"]';
        this.errorGross = '//*[@for="number_input_annual_income"]';
        this.errorMothers = '//*[@for="number_input_monther_name"]';
        this.inputGross = '(//input)[6]';
        this.inputCompany = '(//input)[7]';
        this.inputMother = '(//input)[8]';
        this.pincode = '//*[@for="pincode"]';
        this.labelPincode = '//*[@for="pincode"]';
    }
    ...
    async emailFieldInput2(){
        return await $(this.email2).getText();
    }
    async mobileText(){
    ...
    async mothersInputReader(){
        return await $(this.inputMother).getValue();
    }
    ...
    async emailLabelReader(){
        return await $(this.emailLabel).getText();
    }
   async grossIncomeInput(value){
    return await $(this.income).setValue(value);
   }
   async grossErrorMessage(){
    return await $(this.errorGross).getText();
   }
   async motherInput(value){
    return await $(this.mother).setValue(value);
   }
   async mothersErrorMessage(){
    return await $(this.errorMothers).getText();
   }
   async emailFieldInput(value){
    return await $(this.email).setValue(value);
}
async pincodeInput(value){
    return await $(this.pincode).setValue(value);
}
async pincodeErrorMsg(){
    return await $(this.labelPincode).getText();
}
